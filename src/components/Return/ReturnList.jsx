...
import { ReturnListRequest } from '../../apiRequests/ReturnAPIRequest'
...
const ReturnList = () => {
    ...
    const ReturnList = useSelector((state) => state?.return?.ReturnList)
    const TotalReturn = useSelector((state) => state?.return?.TotalReturn)

    const OnPageChangeClick = async (event) => {
        await ReturnListRequest(event.selected + 1, perPage, search)
    }

    const OnPerPageChange = async (event) => {
        setPerPage(event.target.value);
        await ReturnListRequest(1, event.target.value, search)
    }
    ...
    const OnSearchClick = async () => {
        await ReturnListRequest(1, perPage, search)
    }
                        ...
                        <div className='card-body'>
                            <div className='row'>
                                <div className='col-lg-4'>
                                    <h4 className='font-weight-bolder'>Return List</h4>
                                </div>
